...
From the confusion matrix, we can know the model fit the dataset perfectly. Other models were also tested, but cannot acheive the comparable accuracy as this one. The submission results are all right according to the submission part of this project.
